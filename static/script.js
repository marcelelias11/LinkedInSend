...
function getExperienceLevels() {
  const getCheckboxValue = (value) => {
    const element = document.querySelector(
      `input[name="expLevel"][value="${value}"]`
    );
...
function getJobTypes() {
  return {
    "full-time": document.querySelector(
      'input[name="jobType"][value="full-time"]'
    ).checked,
    contract: document.querySelector('input[name="jobType"][value="contract"]')
      .checked,
    "part-time": document.querySelector(
      'input[name="jobType"][value="part-time"]'
    ).checked,
    temporary: document.querySelector(
      'input[name="jobType"][value="temporary"]'
    ).checked,
    internship: document.querySelector(
      'input[name="jobType"][value="internship"]'
    ).checked,
    other: document.querySelector('input[name="jobType"][value="other"]')
      .checked,
    volunteer: document.querySelector(
      'input[name="jobType"][value="volunteer"]'
    ).checked,
  };
}
...
function getDatePosted() {
  return {
    "all time": document.querySelector(
      'input[name="datePosted"][value="all time"]'
    ).checked,
    month: document.querySelector('input[name="datePosted"][value="month"]')
      .checked,
    week: document.querySelector('input[name="datePosted"][value="week"]')
      .checked,
    "24 hours": document.querySelector(
      'input[name="datePosted"][value="24 hours"]'
    ).checked,
  };
}
